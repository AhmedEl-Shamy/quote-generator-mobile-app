...
class GetAllFavoritesUseCase extends UseCaseWithParam<
    Future<Either<Failure, List<QuoteEntity>>>, List<String>> {
  final FavoritesRepo _favoritesRepo;

  GetAllFavoritesUseCase({required FavoritesRepo favoritesRepo})
      : _favoritesRepo = favoritesRepo;
  @override
  Future<Either<Failure, List<QuoteEntity>>> call(List<String> param) {
    return _favoritesRepo.getAllFavorites(param);
  }
}
